  ...
  content: (
    <>
      <div className="w-screen max-w-none px-0 md:px-[clamp(3.5rem,10vw,7rem)] py-[clamp(3rem,8vh,5rem)]">
        <div className="grid w-full min-h-[calc(100vh-11rem)] md:min-h-0 content-center grid-cols-1 gap-3 sm:gap-4 md:grid-cols-3 md:grid-rows-4 md:gap-5 items-center justify-items-center">
          ...
          <div className="w-full flex items-center justify-center md:col-start-2 md:row-start-4">
            <GlassBubble
              className="p-4 w-[90vw] md:w-full md:max-w-[26rem] text-xs sm:text-sm md:text-sm lg:text-base"
              fadeIn
              fadeDurationMs={800}
