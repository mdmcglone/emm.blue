  ...
  content: (
    <>
      <div className="w-screen max-w-none px-0 md:px-[clamp(3.5rem,10vw,7rem)] py-[clamp(4rem,10vh,6rem)]">
        <div className="grid w-full min-h-[calc(100vh-11rem)] md:min-h-0 content-center grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
          <div className="w-full flex items-center justify-center md:col-span-2 md:row-start-1">
            <GlassBubble
          ...
          <div className="w-full flex items-center justify-center md:col-start-2 md:row-start-2 md:justify-self-start">
            <GlassBubble
          ...
          <div className="w-full flex items-center justify-center md:col-start-2 md:row-start-3 md:justify-self-start md:translate-x-8 lg:translate-x-12">
            <GlassBubble
              className="p-4 w-[90vw] md:w-full md:max-w-[26rem] md:mr-auto text-xs sm:text-sm md:text-sm lg:text-base"
              fadeIn
              fadeDurationMs={800}
          ...
          <div className="w-full flex items-center justify-center md:col-start-1 md:row-start-3 md:justify-self-end md:-translate-x-8 lg:-translate-x-12">
            <GlassBubble
              className="p-4 w-[90vw] md:w-full md:max-w-[26rem] md:ml-auto text-xs sm:text-sm md:text-sm lg:text-base"
              fadeIn
              fadeDurationMs={800}
