        ...
        <div className="flex flex-col md:grid w-full min-h-[calc(100vh-11rem)] md:min-h-0 md:grid-cols-3 gap-4 md:gap-6 items-center justify-center md:justify-items-center md:h-screen md:content-center">
          ...
          <div className="w-full md:h-full flex items-center justify-center">
            <GlassBubble
              ...
              fadeDelayMs={800}
            >
              I became CTO. I interviewed dozens of candidates and hired eight engineers over two years. My job shifted more and more into giving technical leadership and reviewing code, than writing it myself. I learned client and employee management skills, agile development, and how to scale systems and teams.
            </GlassBubble>
          </div>
        </div>
      </div>
