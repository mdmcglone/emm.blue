...
function AsteroidsGame() {
  ...
  return (
    ...
    >
      ...
      {hasTouched && (
        <>
          <div className="absolute left-4 bottom-14 md:bottom-[6.5rem] z-50 flex items-end gap-3 [font-family:Inter,system-ui,-apple-system,sans-serif]">
            <button
              type="button"
          ...
          <div className="absolute right-4 bottom-14 md:bottom-[6.5rem] z-50 flex items-end gap-3 [font-family:Inter,system-ui,-apple-system,sans-serif]">
            <button
              type="button"
              aria-label="Fire"
