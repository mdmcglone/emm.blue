...
export const Cell_1_3: CellConfig = {
  content: (
    <>
      <div className="w-screen max-w-none px-0 md:px-[clamp(3rem,9vw,6rem)] py-[clamp(4rem,10vh,6rem)]">
        {/* On md+ treat as row, keep centered but allow bubble content no forced min-height */}
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-11rem)] md:min-h-0 gap-4 sm:gap-5 md:flex-row md:items-center md:justify-center md:gap-7 lg:gap-10">
