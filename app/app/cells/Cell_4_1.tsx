  ...
  content: (
    <>
      <div className="w-[90vw] md:w-screen max-w-none px-[clamp(2.5rem,8vw,5rem)] py-[clamp(3rem,8vh,5rem)]">
        <div className="grid w-full min-h-[calc(100dvh-11rem)] md:min-h-0 content-center grid-cols-1 gap-3 sm:gap-4 md:grid-cols-5 md:grid-rows-3 md:gap-2 items-center justify-items-center">
          <GlassBubble
